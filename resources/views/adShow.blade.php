                ...
                <div class="productView">
                    ...
                    <div class="productContact">
                        ...
                        <div class="user">
                            ...
                            <div class="contacts">
                                <div>
                                    <svg style="margin-right: 6px" width="16" height="16" viewBox="0 0 16 16"
                                         fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <div class="contactsInfo">
                                    <p>
                                        <svg style="margin-right: 10px" width="16" height="16" viewBox="0 0 16 16"
                                             fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                  d="M7.68719 8.31484C10.3466 10.9735 10.9499 7.89772 12.6431 9.58979C14.2756 11.2218 15.2138 11.5487 13.1455 13.6164C12.8865 13.8246 11.2404 16.3294 5.45576 10.5464C-0.329641 4.76257 2.17374 3.11486 2.382 2.85587C4.45527 0.78246 4.7766 1.72615 6.40902 3.35812C8.10227 5.0509 5.0278 5.65618 7.68719 8.31484Z"
                                                  stroke="#23262F" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        Номер Телефона
                                    </p>
                            ...
                            <button class="writeMessage">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    ...
                                    <path d="M10.6262 8.27523H10.6322" stroke="white" stroke-width="1.5"
                                          stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M7.95338 8.27523H7.95938" stroke="white" stroke-width="1.5"
                                          stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M5.28053 8.27523H5.28653" stroke="white" stroke-width="1.5"
                                          stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                Написать продавцу
                            </button>
                            <button class="orderCall">
                                <svg width="17" height="16" viewBox="0 0 17 16" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M8.18815 8.31488C10.8475 10.9735 11.4508 7.89777 13.1441 9.58983C14.7765 11.2218 15.7147 11.5488 13.6465 13.6164C13.3874 13.8246 11.7414 16.3295 5.95673 10.5464C0.17134 4.76263 2.67472 3.11492 2.88297 2.85593C4.95624 0.782523 5.27757 1.72621 6.90999 3.35818C8.60323 5.05096 5.52876 5.65624 8.18815 8.31488Z"
                                          stroke="#23262F" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            ...
                            <div class="additionalInfo">
                                <p class="review">
                                    <svg width="18" height="14" viewBox="0 0 18 14" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                              d="M11.6344 7.04413C11.6344 8.49913 10.4544 9.6783 8.99941 9.6783C7.5444 9.6783 6.36523 8.49913 6.36523 7.04413C6.36523 5.58829 7.5444 4.40912 8.99941 4.40912C10.4544 4.40912 11.6344 5.58829 11.6344 7.04413Z"
                                              stroke="#23262F" stroke-width="1.25" stroke-linecap="round"
                                              stroke-linejoin="round"/>
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                              d="M8.9977 13.129C12.171 13.129 15.0735 10.8473 16.7077 7.04394C15.0735 3.2406 12.171 0.958923 8.9977 0.958923H9.00103C5.82769 0.958923 2.92519 3.2406 1.29102 7.04394C2.92519 10.8473 5.82769 13.129 9.00103 13.129H8.9977Z"
                                              stroke="#23262F" stroke-width="1.25" stroke-linecap="round"
                                              stroke-linejoin="round"/>
                                    </svg>
                                ...
                                <p class="saved">
                                    <svg width="16" height="18" viewBox="0 0 16 18" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                              d="M14.4491 4.128C14.4491 1.83559 12.8818 0.916626 10.6253 0.916626H5.32624C3.1391 0.916626 1.5 1.77294 1.5 3.97511V16.245C1.5 16.8498 2.1508 17.2308 2.67795 16.935L7.99626 13.9517L13.2686 16.93C13.7966 17.2274 14.4491 16.8465 14.4491 16.2408V4.128Z"
                                              stroke="#23262F" stroke-width="1.25" stroke-linecap="round"
                                              stroke-linejoin="round"/>
                                        <path d="M4.89258 6.5233H10.9912" stroke="#23262F" stroke-width="1.25"
                                              stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
