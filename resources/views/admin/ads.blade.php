                ...
                <tr>
                    ...
                    <td>
                        <form class="form-group" action="{{ route('adUpdate', $ad['id']) }}" method="post">
                            ...
                            <button class="btn btn-success bthChange" type="submit" @if(Auth::user()->isModerator()) disabled @endif>
                                <p>Изменить</p>
                    ...
                    <td class="d-flex flex-row">
                        <form action="{{ route('adDestroy', $ad['id']) }}" method="post">
                            @method('DELETE')
                            @csrf
                            <Button class="btn btn-danger bthDel" @if(Auth::user()->isModerator()) disabled @endif>
