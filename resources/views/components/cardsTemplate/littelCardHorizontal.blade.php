<div class="card">
    <div class="card__content card__content--horizontal">
        ...
        <div class="card__body card__body--horizontal">
            ...
            <div class="card__body-top card__body-top--horizontal">
                ...
                <div class="card__item card__location card__location--horizontal">
                    <p class="card__item-title">Город подачи:
                        <span class="card__item-text">{{ $item->city->name }}</span>
                    </p>
                </div>

                <div class="card__item card__category">
                    <p class="card__item-title">Категория:
                        <span class="card__item-text">{{ $item->category->title }}</span>
                    </p>
                </div>

                <div class="card__item card__add card__add--horizontal">
                    <p class="card__item-title">Опубликовано:
                        <span class="card__item-text">{{ $item->getCreatedDate() }}</span>
                    </p>
                </div>

                @if(!Request::is('listAds'))
                    <div class="card__item card__author">

                        <div class="card__author-img card__author-img--horizontal">
                        ...
                        <div class="card__author-content">
                            <a class="card__author-link" href="{{route('user.public', $item->user->id)}}">
                                <h4 class="card__author-name">{{ $item->user->name }}</h4>
                            </a>
                        </div>
                    </div>
                @endif
        ...
        .org/2000/svg">
                        <path d="M12.62 20.81C12.28 20.93 11.72 20.93 11.38 20.81C8.48 19.82 2 15.69 2 8.68998C2 5.59998 4.49 3.09998 7.56 3.09998C9.38 3.09998 10.99 3.97998 12 5.33998C13.01 3.97998 14.63 3.09998 16.44 3.09998C19.51 3.09998 22 5.59998 22 8.68998C22 15.69 15.52 19.82 12.62 20.81Z"
                              stroke="#23262F" stroke-width="1.5" stroke-opacity="0.5" stroke-linecap="round"
                              stroke-linejoin="round"/>
                    </svg>
                    ...
                    <div class="info__bart">
                        <svg class="actions__icon" width="20" height="20" viewBox="0 0 22 22"
                            ...
                            <path d="M13.6 11.5799V14.3099C13.6 16.5899 12.69 17.4999 10.41 17.4999H7.69C5.42 17.4999 4.5 16.5899 4.5 14.3099V11.5799C4.5 9.3099 5.41 8.3999 7.69 8.3999H10.42C12.69 8.3999 13.6 9.3099 13.6 11.5799Z"
                                  stroke="#23262F" stroke-width="1.5" stroke-linecap="round" stroke-opacity="0.5"
                                  stroke-linejoin="round"/>
