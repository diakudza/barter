    ...
    <div class="card__img">
        ...
        <div class="card__btn-fav">
            <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M4.89258 6.52342H10.9911" stroke="#23262F" stroke-width="1.25" stroke-linecap="round"
            ...
            <div class="card__author">
                <div class="card__author-img">
                    ...
                    <img class="author-img"
                        @if (count($item->imageMain)) src="{{ Storage::url($item->imageMain[0]->path) }}"
          @elseif(count($item->images))

          src="{{ Storage::url($item->images[0]->path) }}"
          @else
          src="https://via.placeholder.com/40x40" @endif
                        alt="{{ $item->user->name }}" title="{{ $item->user->name }}">
                </div>
