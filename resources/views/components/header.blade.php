        ...
        <div class="header__content">
            <nav class="nav-menu" aria-label="Навигация">
                ...
                <ul class="nav-menu__list">
                    <li @if (Route::currentRouteNamed("home")) class="nav-menu__item active"
                        @endif class="nav-menu__item">
                        <a href="{{ route('home') }}" class="nav-menu__link">Главная</a>
                    </li>

                    <li @if (Route::currentRouteNamed("searchPage")) class="nav-menu__item active"
                        @endif class="nav-menu__item">
                        <a href="{{ route('searchPage') }}" class="nav-menu__link">Поиск</a>
                    </li>


                    <li @if (Route::currentRouteNamed("about")) class="nav-menu__item active"
                        @endif class="nav-menu__item">
                        <a href="{{ route('about') }}" class="nav-menu__link">О проекте</a>
                    </li>

                    @if(auth()->user() && in_array(auth()->user()->getRole->role , ['admin', 'developer']))
                        <li @if (Route::currentRouteNamed("adminmain")) class="nav-menu__item active"
                            @endif class="nav-menu__item">
            ...
            <div class="header__profile top-profile">
                    ...
                    @if(auth()->user())
                        <div class="top-profile__actions actions">
                            ...
                            <a class="actions__btn" href="{{ route('user.wishlist') }}"
                               title="Ваши добавления">
                                <svg class="actions__icon" width="18" height="22" viewBox="0 0 18 22"
                                     fill="none"
                            ...
                            @if (auth()->user()->someoneAddedUnreadAds->sum('adcount'))
                                <a class="actions__btn" href="{{route('user.profile.listAds')}}">
                                    <svg class="actions__icon" width="20" height="22" viewBox="0 0 20 22"
                                         fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                              ...
                                              stroke-linejoin="round"/>
                                        <path
                                            d="M12.3889 19.8572C11.0247 21.372 8.89672 21.3899 7.51953 19.8572"
                                            stroke="#23262F" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round"/>
                                    </svg>
                ...
                @if(auth()->user())
                    <a class="nav-menu__btn btn btn-blue" href="{{route('user.profile.createAd')}}">
                        Выставить объявление</a>
                                        ...
                                        <span>
                                            <svg width="19" height="19" viewBox="0 0 19 19" fill="none"
                                                ...
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    ...
                                                    stroke="#23262F" stroke-opacity="0.6" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <circle cx="9.67565" cy="9.67575" r="8.00914" stroke="#23262F"
                                    ...
                                    <li class="profile-menu__item">
                                        <span>
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M11.5134 5.15756V4.38006C11.5134 2.68423 10.1384 1.30923 8.44255 1.30923H4.38006C2.68506 1.30923 1.31006 2.68423 1.31006 4.38006V13.6551C1.31006 15.3509 2.68506 16.7259 4.38006 16.7259H8.45088C10.1417 16.7259 11.5134 15.3551 11.5134 13.6642V12.8784"
                                                    stroke="#EF4646" stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round"/>
                                                <path d="M17.1748 9.01747H7.14062" stroke="#EF4646"
                                                      stroke-width="1.5" stroke-linecap="round"
                                                      stroke-linejoin="round"/>
                                                <path d="M14.7344 6.58823L17.1744 9.01739L14.7344 11.4474"
                                                      stroke="#EF4646" stroke-width="1.5" stroke-linecap="round"
                                                      stroke-linejoin="round"/>
                                            </svg>
                                        </span>
