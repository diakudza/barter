    ...
    <ul class="profile-menu__list">
            ...
            <li class="profile-menu__item">
                <a class="profile-menu__link" href="{{ route('adminmain') }}">
                    ...
                    19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="9.67565" cy="9.67575" r="8.00914" stroke-width="1.5" stroke-linecap="round"
        ...
        <li class="profile-menu__item">
            <a class="profile-menu__link" href="{{ route('user.profile.personalData') }}">
                <svg class="profile-menu__icon profile-menu__icon--setting" width="16" height="18"
        ...
        {{--                <svg class="profile-menu__icon profile-menu__icon--buy" width="18" height="18"--}}
        ...
        <li class="profile-menu__item">
            <a class="profile-menu__link" href="{{ route('user.wishlist') }} ">
                <svg class="profile-menu__icon" width="22" height="22" viewBox="0 0 22 22"
                ...
                <span class="profile-menu__item-name">Мой бартер</span>
            </a>
        </li>
        <li class="profile-menu__item">
            <a class="profile-menu__link" href="{{ route('logout') }}">
                <svg class="profile-menu__icon profile-menu__icon--exit" width="18" height="18"
                     viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
