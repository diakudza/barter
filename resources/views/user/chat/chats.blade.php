        ...
        <div class="chats">
            ...
            <div class="chats__list">
                <div class="chats__list_info">
                    <h3 class="chats__list_info-heading">Сообщения <p class="chats__list_info-count">(12)</p></h3>
            ...
            <div class="chats__chat">
                ...
                <div class="chats__chat_write">
                    ...
                    <input  class="chats__chat_write-input" type="text" placeholder="Пишите здесь...">
                    <div class="chats__chat_write-send">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
