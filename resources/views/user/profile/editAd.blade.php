    ...
    <div class="container">
        ...
        <form action="{{ route('ad.update', $ad->id) }}" method="post" enctype="multipart/form-data" class="form-1">
                        ...
                        @forelse ($ad->images as $image)
                            <div class="col-sm-4">
                                ...
                                <div class="form-group d-flex justify-content-sm-evenly">
                                    ...
                                    <input type="radio" name="imageMain" id="imageMain" value="{{ $image->id }}" class="form-check"
                                           @if ($image->image_type == 0) checked @endif>
            ...
            <div>
                ...
                <select name="category_id" id="category_id" required class="form-select w-50">
            ...
            <div>
                ...
                <select name="city_id" id="city_id" required class="form-select w-50">
            ...
            <div>
                ...
                <select name="status_id" id="status_id" class="form-select w-50">
