...
{{--        <form action="{{ route('user.updateUserData') }}" method="post" class="change-user__info d-flex col gap-5"--}}
...
{{--        </form>--}}
        ...
        <form action="#" method="POST" class="change-user__info d-flex col gap-5"
              enctype="multipart/form-data">
{{--            @csrf--}}
{{--            @method('put')--}}
            <div>
