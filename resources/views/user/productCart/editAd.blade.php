                ...
                <div class="change-form__group change-item">
                    ...
                    <div class="change-item__list">
                        <div class="change-item__item">
                            ...
                            <input class="change-item__input input" type="text" id="title" name="title" placeholder="Название товара" value="@if (old('title')) {{ old('title') }}@else{{ $ad->title }} @endif" required>
                        </div>
                        ...
                        <div class="change-item__item">
                            ...
                            <textarea class="change-item__input input input__textarea" name="text" id="text" rows="3"
                                      placeholder="Напишите полное описание товара"   required>@if (old('text')){{ old('text') }}@else{{ $ad->text }}@endif</textarea>
                        </div>
...
{{--                </div>--}}
            ...
            <div class="change-form__buttons">
                <button type="submit" class="btn btn-blue btn-reset change-form__btn" title="Изменить объявление">Изменить</button>
                <button type="reset" class="btn btn-reset btn-black change-form__btn" title="Отменить изменения">Отменить изменения</button>
            </div>
        </form>
...
{{--                            </select>--}}
                    ...
                    @empty
                        <img src="{{ asset('images/product/placeholder400x400.png' )}}" alt="{{ $ad->title }}" title="{{ $ad->title }}">
                    @endforelse
                </div>
            ...
            <form class="change-form__del" action="{{ route('ad.destroy', $ad->id) }}" method="post">
                ...
                <button type="submit" class="btn btn-reset btn-del change-form__btn" title="Удалить объявление">
                    <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14.1042 6.39062C14.1042 6.39062 13.6517 12.0031 13.3892 14.3673C13.2642 15.4965 12.5667 16.1581 11.4242 16.179C9.24999 16.2181 7.07332 16.2206 4.89999 16.1748C3.80082 16.1523 3.11499 15.4823 2.99249 14.3731C2.72832 11.9881 2.27832 6.39062 2.27832 6.39062" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M15.2567 3.69987H1.125" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M12.5335 3.69998C11.8793 3.69998 11.316 3.23748 11.1877 2.59665L10.9852 1.58331C10.8602 1.11581 10.4368 0.79248 9.95432 0.79248H6.42682C5.94432 0.79248 5.52099 1.11581 5.39599 1.58331L5.19349 2.59665C5.06516 3.23748 4.50182 3.69998 3.84766 3.69998" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
            </form>
        </div>
